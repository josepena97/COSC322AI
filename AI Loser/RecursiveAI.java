...
//	    	}
//    		//System.out.println("MIN-MAX ALPHA-BETA:");
    		NodeGraph moveNode = miniMax(graph, new NodeGraph(-Double.MAX_VALUE, "Alpha"), new NodeGraph(Double.MAX_VALUE, "Beta"), true);
...
//				);
    	...
    	if(maximizingPlayer) {
    		NodeGraph best = new NodeGraph(-Double.MAX_VALUE, "BestMax " + minmaxcounter++);
...
//    		System.out.println("\n Name: " + best.name);
    		...
    		NodeGraph best = new NodeGraph(Double.MAX_VALUE, "BestAlpha " + minmaxcounter++);
    		for(int i = 0; i < node.children.size(); i++) {
